      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          ...
          <div className="relative">
            <div className="flex overflow-x-auto md:overflow-visible flex-nowrap md:flex-wrap gap-2 md:pb-2 pb-4 no-scrollbar [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] md:[mask-image:none]">
              {categories.map((cat) => (
                <button
                  key={cat}
                  onClick={() => {
                ...
                >
                  ...
                  <span className={`relative z-10 ${activeCategory === cat ? "text-bg" : "text-primary"}`}>
                    {cat}
                  </span>
                </button>
              ))}
        ...
        {/* GALLERY GRID */}
        <div className="grid grid-flow-dense grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[250px] md:auto-rows-[300px]">
