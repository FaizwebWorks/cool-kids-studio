    ...
    <section className="relative w-full flex flex-col items-center justify-center text-center px-6 pt-32 pb-20 overflow-hidden bg-bg">
      <div className="w-full max-w-full overflow-hidden">
        <motion.h1
          ...
          className="text-[2.5rem] font-bold font-heading text-primary tracking-tight uppercase leading-[1.1]"
        >
      ...
      <motion.p
        ...
        className="mt-8 text-center text-text-secondary max-w-xs text-sm font-normal tracking-tight leading-relaxed opacity-80"
      >
